...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
     * |   FN   | LCTRL  | LALT   | LGUI   | space  | space  |  left  |  down  | right  | space  | space  |  RGUI  |  RALT  | RCTRL  |  menu  |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_QWERTY] = LAYOUT_ortho_5x15(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LBRC, KC_BSLS, KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MINS, KC_GRV,  KC_EQL,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_PSCR, KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_UP,   KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, ENTERS,
        FN,      KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC,  KC_SPC,  KC_RGUI, KC_RALT, KC_RCTL, KC_APP
    ),
    ...
    [_COLEMAK] = LAYOUT_ortho_5x15(
        _______, KC_9,    KC_5,    KC_3,    KC_1,    KC_7,    _______, _______, _______, KC_6,    KC_0,    KC_2,    KC_4,    KC_8,    _______,
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
     * |        | Bright+|  Sat+  |  Hue+  | RGBmod+| RGBpln |   P7   |   P8   |   P9   |   P-   | prscr  | scrlk  | pause  |  ins   |  F12   |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
     * |        | Bright-|  Sat-  |  Hue-  | RGBmod-| RGBtog |   P4   |   P5   |   P6   |   P+   |  prev  |  play  |  next  |  stop  | power  |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    ...
    [_FN] = LAYOUT_ortho_5x15(
        ...
        COLEMAK, RGB_VAD, RGB_SAD, RGB_HUD, RGB_RMOD,RGB_TOG, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, KC_PWR,
